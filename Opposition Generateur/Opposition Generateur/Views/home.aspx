<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="Opposition_Generateur.Views.home" %>
...
<head runat="server">
    ...
    <style>
        ...
        body {
            background: linear-gradient(-45deg, #4682B4, #0E3386,#041E42);
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <div class="d-flex flex-column justify-content-center w-100 h-100">
                        ...
                        <section class="flex justify-center items-center h-screen">
                            ...
                            <img src="../Assets/icon/thumbnail_ipp-logo-homepage.png" />
                        </section>
