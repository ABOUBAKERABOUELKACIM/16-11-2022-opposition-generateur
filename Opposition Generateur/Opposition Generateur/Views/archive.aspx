<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="archive.aspx.cs" Inherits="Opposition_Generateur.Views.archive" %>
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <header class="bg-slate-900">
                    <div class="flex justify-between items-center md:px-8 px-4 border-b border-gray-700">
                        <a href="home.aspx" class="py-4 md:text-2xl text-sm font-bold capitalize text-white"><i class="fa-solid fa-arrow-left md:text-lg text-sm md:pr-4 pr-2"></i>Archive</a>
                    ...
                    <div class="flex flex-wrap mt-4">
                            <div class="md:basis-1/2 basis-full">
                                ...
                                <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                            <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">Referance d'alert :</legend>
                                                                <input  class=" lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" name="search_field"  id="search_field" type="text" />
                                ...
                                <div class="mb-4 md:px-2">
                                        <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                            <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">date creation debut :</legend>
                                            <input type="date" name="date_depot_debut" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="date_depot_debut" style="width: 30%" />
                                        </fieldset>
                                    </div>
                                </div>
                        ...
                        <div class="md:basis-1/2 basis-full">
                            <div class="mb-4 md:px-2">
                                        <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                            <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">User Nom:</legend>
                                            <input type="text" name="user" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="user" style="width: 30%" />
                                        </fieldset>
                                    </div>
                             <div class="mb-4 md:px-2">
                                        <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                            <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">date creation fin :</legend>
                                            <input type="date" name="date_depot_fin" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="date_depot_fin" style="width: 30%" />
                                        </fieldset>
                                    </div>
                        ...
                        <div class="md:basis-1/2 basis-full">
                                 <div class="mb-4 md:px-2">
                                <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                            <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">Type :</legend>
                                                                <input  class=" lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" name="Type"  id="Type" type="text" />
                ...
                <asp:ImageButton ID="ImageButton5" Style='display: inline-block' runat="server" OnClick="expoert_select_Click" ImageUrl="..\Assets\icon/pdf-select.png" Height="50" Width="50" />
                    ...
                    <asp:GridView OnSorting="GridView1_Sorting" ShowHeaderWhenEmpty="True"  class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Arial" HeaderStyle-BackColor="#0EA5E9" Font-Size="8pt" AllowSorting="True" OnDataBound="GridView1_DataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Ref" DataField="Titulaire" SortExpression="Id" />
                            <asp:BoundField DataField="Etat" HeaderText="Type" />
                            <asp:BoundField HeaderText="User" DataField="NumeroTitre" />
                            <asp:BoundField HeaderText="Date creation" DataField="NomMarque" SortExpression="NomMarque" />
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:Button ID="download" OnClick="Visit_link_Click" CssClass="bg-green-500 py-2 px-3" runat="server" Text="download"  />
