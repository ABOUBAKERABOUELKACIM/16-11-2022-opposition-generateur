<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rechercheopps.aspx.cs" Inherits="Opposition_Generateur.Views.Rechercheopps" %>
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <header class="bg-slate-900">
                    <div class="flex justify-between items-center md:px-8 px-4 border-b border-gray-700">
                        <a href="home.aspx" class="py-4 md:text-2xl text-sm font-bold capitalize text-white"><i class="fa-solid fa-arrow-left md:text-lg text-sm md:pr-4 pr-2"></i>recherche Oppositions</a>
                    ...
                    <div class="rounded border border-gray-400">
                        <!-- FORM START -->
                            ...
                            <h4 class="md:text-xl text-lg font-bold">Saisie les informations des marques: </h4>
                                ...
                                <label class="pr-2 lg:text-base text-sm font-medium" for="ShowOrHide">Afficher/Masquer les champs des marques antérieure.</label>
                            ...
                            <div class="md:basis-1/2 basis-full">
                                <div class="mb-4 md:px-2">
                                        <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                            <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">Numero de opposition :</legend>
                                            <input type="text" name="num_op" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="num_op" style="width: 30%" />
                                        </fieldset>
                                    </div>
                               ...
                               <div class="mb-4 md:px-2">
                                ...
                                <div class="md:basis-1/2 basis-full">
                                    <div class="mb-4 md:px-2">
                                            <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                                <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="nom_marq">Nom de la marque antérieure:</legend>
                                                <input type="text" name="nom_marqant" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="nom_marqant" />
                                            </fieldset>
                                        </div>

                                        <div class="mb-4 md:px-2">
                                            <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                                <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="deposant">Déposant :</legend>
                                                <input type="text" name="deposantant" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="deposantant" />
                                            </fieldset>
                                        </div>
                                        <div class="mb-4 md:px-2">
                                            <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">

                                                <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="Classe_nice">Classe nice :</legend>
                                                <input type="text" name="Classe_niceant" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="Classe_niceant" />
                                            </fieldset>
                                        </div>
                                    </div>
                                 ...
                                 <div class="md:basis-1/2 basis-full">
                                        <div class="mb-4 md:px-2">
                                            <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                                <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="num_marq">Numero de marque antérieure :</legend>
                                                <input type="text" name="num_marqant" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="num_marqant" />
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="mb-4 md:px-2">
                                            <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                                <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="mandataire">Mandataire :</legend>
                                                <input type="text" name="mandataireant" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="mandataireant" />
                                            </fieldset>
                                        </div>
                                        <div class="mb-4 md:px-2">
                                            <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                                ...
                                                <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="Etat">Etat :</legend>
                                                <input style="padding-top: 7px" type="text" name="Etatcant" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="Etatcant" />
                                            </fieldset>
                                        </div>
                                    </div>
                        ...
                        <div>
                            ...
                            <asp:ImageButton ID="ImageButton3" runat="server" OnClick="Button1_Click" ImageUrl="~/Assets/icon/upload.png" Height="50px" Width="50px" />
                            &nbsp;<asp:ImageButton ID="ImageButton4" runat="server" OnClick="PDF_Click" ImageUrl="~/Assets/icon/pdf.png" Height="50" Width="50" />
                            &nbsp;
                <asp:ImageButton ID="ImageButton5" runat="server" OnClick="PDFSELECT_Click" Height="50" Width="50" ImageUrl="~/Assets/icon/pdf-select.png" />
                ...
                <asp:GridView ShowHeaderWhenEmpty="True" HeaderStyle-BackColor="#0EA5E9" class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Arial" Font-Size="8pt"  ClientIDMode="Static" OnDataBound="GridView1_DataBound"  Height="50px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
                    ...
                    <Columns>
                        ...
                        <asp:BoundField AccessibleHeaderText="Numéro Opposition" DataField="num_op" HeaderText="Numéro Opposition" />
                        <asp:BoundField AccessibleHeaderText="Marque Contestée" DataField="marque_c" HeaderText="Marque Contestée" HtmlEncode="False" />
                        ...
                        <asp:TemplateField HeaderText="Image marque similaire">
                            <ItemTemplate>
                            <asp:Image CssClass="Image__item" Height = "90" Width = "90" runat="server" ImageUrl='<%# "~/Assets/Brand_image/"+Eval("ImageA").ToString() %>' />                           
                            </ItemTemplate>

                        </asp:TemplateField>
                        <asp:BoundField DataField="marq_a" HeaderText="Marque Antérieure" HtmlEncode="False" />
                        <asp:BoundField DataField="decision" HeaderText="Décision" />
                        <asp:BoundField AccessibleHeaderText="Statut" DataField="Statut" HeaderText="Statut"></asp:BoundField>
                    </Columns>
