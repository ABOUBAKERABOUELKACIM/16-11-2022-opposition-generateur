    ...
    <form id="form1" runat="server">
        <div class="flex flex-row relative w-full max-h-full">
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <asp:GridView ShowHeaderWhenEmpty="True" OnRowDeleting="GridView1_RowDeleting" class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" HeaderStyle-BackColor="#0EA5E9" Font-Names="Arial" Font-Size="8pt">
                    ...
                    <Columns>
                        ...
                        <asp:CommandField ButtonType="Button" ControlStyle-CssClass="btn-danger border-0 py-2 px-2 rounded-2" ShowDeleteButton="true" DeleteText="Supprimer" HeaderText="Action">
                            <ControlStyle CssClass="bg-green-500 py-2 px-3"></ControlStyle>
                        </asp:CommandField>
                    </Columns>
                ...
                <br />
                  <div class="md:py-6 py-4 md:px-4 px-2">
                    <asp:Button OnClick="Button1_Click" class="md:px-8 px-4 md:text-base text-sm mt-2 py-2 rounded-md font-medium text-white bg-sky-500 hover:bg-sky-600 sl-animated" ID="Button1" runat="server" Text="Générer les documents" />
                      <asp:Button OnClick="Button2_Click" class="md:px-8 px-4 md:text-base text-sm mt-2 py-2 rounded-md font-medium text-white bg-sky-500 hover:bg-sky-600 sl-animated" ID="Button2" runat="server" Text="Resultat" />
                </div>
                         <!-- BUTTON END -->
                    </div>
               </div>
