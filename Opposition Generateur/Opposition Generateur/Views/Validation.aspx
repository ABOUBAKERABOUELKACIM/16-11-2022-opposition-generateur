<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Validation.aspx.cs" Inherits="Opposition_Generateur.Views.Validation" %>
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <header class="bg-slate-900">
                    <div class="flex justify-between items-center md:px-8 px-4 border-b border-gray-700">
                        <a href="home.aspx" class="py-4 md:text-2xl text-sm font-bold capitalize text-white"><i class="fa-solid fa-arrow-left md:text-lg text-sm md:pr-4 pr-2"></i>Validation des conflits</a>
                        ...
                        <div class="flex flex-wrap mt-4">
                            <div class="md:basis-1/2 basis-full">
                                ...
                                <div class="mb-4 md:px-2">
                                 ...
                                 <div class="mb-4 md:px-2">
                                             <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                             <legend for="date_debu">Date début :</legend>
                            ...
                            <div class="md:basis-1/2 basis-full">
                                ...
                                <div class="mb-4 md:px-2">
                                    <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                        <legend for="fin_date">Fin date :</legend>
                ...
                <asp:GridView ShowHeaderWhenEmpty="True" HeaderStyle-BackColor="#0EA5E9" class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Arial" Font-Size="8pt" ClientIDMode="Static" OnDataBound="GridView1_DataBound" Height="50px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:Button ID="Generate_ang_doc" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="Valider" />

                                <asp:Button ID="Generate_doc" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="Supprimer" />
