<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notification.aspx.cs" Inherits="Opposition_Generateur.Views.notification" %>
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <header class="bg-slate-900">
                    <div class="flex justify-between items-center md:px-8 px-4 border-b border-gray-700">
                        <a href="home.aspx" class="py-4 md:text-2xl text-sm font-bold capitalize text-white"><i class="fa-solid fa-arrow-left md:text-lg text-sm md:pr-4 pr-2"></i>Notification des conflits</a>
                ...
                <asp:GridView ShowHeaderWhenEmpty="True" HeaderStyle-BackColor="#0EA5E9" class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Arial" Font-Size="8pt" ClientIDMode="Static" OnDataBound="GridView1_DataBound" Height="50px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Date_valid" HeaderText="Date validation" />

                        <asp:TemplateField HeaderText="PDF">
                            <ItemTemplate>
                                <asp:Button ID="frdoc" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="version Fr" />
                                <asp:Button ID="engdoc" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="version En" />
                         ...
                         <asp:TemplateField HeaderText="Detail">
                            <ItemTemplate>
                                <asp:Button ID="contester" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="contestée" />
                                <asp:Button ID="anterieur" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="Antérieure" />


                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="valider facon d'evoi">
                            <ItemTemplate>
