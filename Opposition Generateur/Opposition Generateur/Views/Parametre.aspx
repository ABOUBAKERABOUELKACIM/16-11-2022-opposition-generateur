  ...
  <div id="sidebar" class="lg:block hidden fixed overflow-y-scroll z-10 left-0 top-0 w-[220px] h-screen bg-slate-900">
          ...
          <main class="lg:ml-[220px] w-full min-h-screen gradient-light ">
               <!-- HEADER START -->
                <header class="bg-slate-900">
                    <div class="flex justify-between items-center md:px-8 px-4 border-b border-gray-700">
                        <a href="home.aspx" class="py-4 md:text-2xl text-sm font-bold capitalize text-white"><i class="fa-solid fa-arrow-left md:text-lg text-sm md:pr-4 pr-2"></i>Parametre</a>
               ...
               <!-- HEADER END -->
                ...
                <asp:GridView OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" ShowFooter="True" ShowHeaderWhenEmpty="True" HeaderStyle-BackColor="#0EA5E9" class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Arial" Font-Size="8pt">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            ...
                            <ItemTemplate>
                                <asp:Button ID="Delete" CssClass="bg-red-500 py-2 px-3" runat="server" Text="Supprimer" OnClick="Delete_Click" />
                                <asp:Button ID="btn_Edit" runat="server" CssClass="bg-green-500 py-2 px-3" Text="Modifier" CommandName="Edit" />
                            </ItemTemplate>
                            ...
                            <FooterTemplate>
                                <asp:Button ID="btn_Insert" runat="server" CssClass="bg-green-500 py-2 px-3" Text="Inserer" OnClick="btn_Insert_Click" />
                            </FooterTemplate>
                        </asp:TemplateField>
