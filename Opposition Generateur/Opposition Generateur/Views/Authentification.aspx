     ...
     <main class="w-screen h-screen flex items-center justify-center gradient-light">
          <section class="md:w-[30rem] w-[95%] md:p-10 p-4 shadow-lg bg-white rounded">
               <img class="md:h-14 h-10 mx-auto mb-6" src="../Assets/Img/NewLogo.png" alt="logo" />
                    ...
                    <input type="text" placeholder="Username*"  runat="server"  name="username" id="signin_username" class="border border-gray-300 hover:border-sky-500 focus:border-sky-500 md:py-4 py-3 md:px-3 px-2 md:text-base text-sm rounded-sm mb-4 w-full" />     
                    <input type="password" placeholder="Password*" runat="server"  name="password" id="signin_password"  class="border border-gray-300 hover:border-sky-500 focus:border-sky-500 md:py-4 py-3 md:px-3 px-2 md:text-base text-sm rounded-sm mb-4 w-full" />
                    <div class="flex justify-between mb-4">
                         <div class="flex items-center">
                              <input type="checkbox" id="remember" />
                              <label class="md:text-sm text-xs pl-2" for="remember">Remember me</label>
                         </div>
                         <a class="text-sky-500 hover:text-sky-600 md:text-sm text-xs" href="">Forgot password?</a>
                    </div>
                    <asp:Button CssClass="bg-sky-500 hover:bg-sky-600 text-white block w-full md:py-4 py-3 md:text-xl text-lg font-bold rounded" ID="btn_signin" runat="server" Text="Se connecter" OnClick="btn_signin_Click"  />
               
               <p class="text-center mt-2 md:text-base text-sm">Don't have an account? <a class="text-sky-500 hover:text-sky-600" href="http://localhost:62249/Views/Inscription.aspx">Create account</a></p>
          </section>
     </main>
