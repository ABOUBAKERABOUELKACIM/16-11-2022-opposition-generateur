<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestion_not.aspx.cs" Inherits="Opposition_Generateur.Views.gestion_not" %>
            ...
            <main class="lg:ml-[220px] w-full min-h-screen ">
                ...
                <header class="bg-slate-900">
                    <div class="flex justify-between items-center md:px-8 px-4 border-b border-gray-700">
                        <a href="home.aspx" class="py-4 md:text-2xl text-sm font-bold capitalize text-white"><i class="fa-solid fa-arrow-left md:text-lg text-sm md:pr-4 pr-2"></i> Gestion des Notification</a>
                    ...
                    <div class="rounded border border-gray-400">
                        ...
                        <div class="flex flex-wrap mt-4">
                            <div class="md:basis-1/2 basis-full">
                                 ...
                                 <div class="mb-4 md:px-2">
                                    <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                        <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">Référence du marque  :</legend>
                                        <input type="text" name="ref" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" id="ref" />
                                    </fieldset>
                                </div>
                                <div class="mb-4 md:px-2">
                                    <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                ...
                                <div class="mb-4 md:px-2">
                                 ...
                                 <div class="mb-4 md:px-2">
                                             <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                             <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="date_debu">début date de notif  :</legend>
                            ...
                            <div class="md:basis-1/2 basis-full">
                               ...
                               <div class="mb-4 md:px-2">
                                    <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                        <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500">Déposant marque anterieure :</legend>
                                ...
                                <div class="mb-4 md:px-2">
                                    <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                        <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500"  for="fin_date">Fin date de notif:</legend>
                                        <input type="date" name="fin_date" class="form-control" id="fin_date" />
                                    </fieldset>
                                </div>
                                <div class="mb-4 md:px-2">
                                     <fieldset class="border border-sky-500 rounded px-2 pt-1 pb-2">
                                    <legend class="md:text-sm text-sm px-1 tracking-wide font-semibold text-sky-500" for="typealert">Type alert :</legend>
                                    <select name="typealert" id="typealert" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" >
                                        <option value=""></option>
                                 ...
                                 <div class="mb-4 md:px-2">
                                      <fieldset class="border border-sky-500 rounded px-3 pt-1 pb-3">
                                    <legend class="md:text-sm text-[11px] px-1 tracking-wide font-semibold text-sky-500" for="sendby">Envoi par :</legend>
                                    <select name="sendby" id="sendby" class="lg:w-4/5 w-full md:text-base text-sm bg-transparent border-b border-gray-500" >
                                        <option value=""></option>
                ...
                <asp:GridView ShowHeaderWhenEmpty="True" HeaderStyle-BackColor="#0EA5E9" class="table lg:w-full w-max" ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Arial" Font-Size="8pt" ClientIDMode="Static" OnDataBound="GridView1_DataBound" Height="50px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    ...
                    <Columns>
                        <asp:BoundField AccessibleHeaderText="Type" HeaderText="Type" HtmlEncode="False" />
                        <asp:TemplateField HeaderText="Destinataire">
                            <ItemTemplate>
                                <asp:Image CssClass="Image__item" Height="90" Width="90" runat="server" ImageUrl='<%# "~/Assets/Brand_image/"+Eval("ImageC").ToString() %>' />
                            </ItemTemplate>

                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Date d'envoie">
                            <ItemTemplate>
                                <asp:Image CssClass="Image__item" Height="90" Width="90" runat="server" ImageUrl='<%# "~/Assets/Brand_image/"+Eval("ImageA").ToString() %>' />
                            </ItemTemplate>

                        </asp:TemplateField>
                        <asp:BoundField DataField="marq_a" HeaderText="moyen d'envoi" HtmlEncode="False" />

                        <asp:TemplateField HeaderText="PDF">
                            <ItemTemplate>
                                <asp:Button ID="Generate_doc" class="text-white bg-sky-500 hover:bg-sky-600 sl-animated py-2 px-3 rounded-full " runat="server" Text="Download" />
