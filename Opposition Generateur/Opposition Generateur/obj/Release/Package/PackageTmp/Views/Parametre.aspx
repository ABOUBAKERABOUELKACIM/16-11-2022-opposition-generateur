<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parametre.aspx.cs" Inherits="Opposition_Generateur.Parametre" %>
...
<body>
    ...
    <div id="page-top">
        ...
        <div id="container">
                ...
                <div class="header">
                    <img src="../Assets/Img/ant-design_setting-filledsetting.png" style="display:block;margin:auto;"/>
                    <img src="../Assets/Img/cropped-logo-2.png" style="position: absolute; top: 0px; right: 0px;width:250px;height:80px"/>
                    <h2 class="container-header-title">Parametre</h2>
                </div><br />

                 <asp:GridView OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" ShowFooter="True" ShowHeaderWhenEmpty="True" class="table container-fluid" ID="GridView1" runat="server" CellPadding="3" GridLines="Vertical" AutoGenerateColumns="False" ForeColor="Black" Font-Names="Arial" Font-Size="8pt" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px">
                 ...
                 <asp:TemplateField HeaderText="Numero publication">  
                    ...
                    <EditItemTemplate>  
                        <asp:TextBox CssClass="GridView1_TxtBox_style" ID="TxtBox_Num_pub" runat="server" Text='<%#Eval("Num_pub") %>'></asp:TextBox>                     
                    </EditItemTemplate>  
                     <FooterTemplate>
                         <asp:TextBox CssClass="GridView1_TxtBox_style" ID="TxtBox_Num_pub_footer" runat="server" ></asp:TextBox>  
                     </FooterTemplate>
                </asp:TemplateField>   
                 <asp:TemplateField HeaderText="Date">  
                    ...
                    <EditItemTemplate>  
                        <asp:TextBox CssClass="GridView1_TxtBox_style" ID="TxtBox_date" runat="server" Text='<%# Eval("Date") %>' ></asp:TextBox>                     
                    </EditItemTemplate>  
                     <FooterTemplate>
                           <asp:TextBox CssClass="GridView1_TxtBox_style" ID="TxtBox_date_footer" runat="server" ></asp:TextBox>       
                     </FooterTemplate>
                </asp:TemplateField>   
                           ...
                           <asp:TemplateField HeaderText="Action">
                            ...
                            <ItemTemplate>                            
                                <asp:Button ID="Delete" CssClass="btn-danger border-0 my-1 py-1 px-1 rounded-2 btn-action" runat="server"  Text="Supprimer" OnClick="Delete_Click" />
                                <asp:Button ID="btn_Edit" runat="server" CssClass="btn-success border-0 my-1 py-1 px-1 rounded-2 btn-action" Text="Modifier" CommandName="Edit" />  
                            </ItemTemplate>

                            <EditItemTemplate>  
                                <asp:Button ID="btn_Update" runat="server" CssClass="btn-success border-0 my-1 py-1 px-1 rounded-2 btn-action" Text="mettre a jour" CommandName="Update"/>  
                                <asp:Button ID="btn_Cancel" runat="server" CssClass="btn-danger border-0 my-1 py-1 px-1 rounded-2 btn-action" Text="Annuler" CommandName="Cancel"/>  
                            </EditItemTemplate>  
                               <FooterTemplate>
                                <asp:Button ID="btn_Insert" runat="server" CssClass="btn-success border-0 my-1 py-1 px-1 rounded-2 btn-action" Text="Inserer" OnClick="btn_Insert_Click" />  
                             </FooterTemplate>
                        </asp:TemplateField>
