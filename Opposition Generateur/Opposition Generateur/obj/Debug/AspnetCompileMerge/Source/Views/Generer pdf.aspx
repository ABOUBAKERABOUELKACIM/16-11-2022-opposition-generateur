...
<body>
    ...
    <div id="page-top">
        ...
        <div id="container">
                ...
                <div class="header">
                    <img src="../Assets/Img/mdi_file-pdf-boxdoc_pdf.png" style="display:block;margin:auto;"/>
                    <img src="../Assets/Img/cropped-logo-2.png" style="position: absolute; top: 0px; right: 0px;width:250px;height:80px"/>
                    <h2 class="container-header-title">Generer document</h2>
                </div><br />

                 <asp:GridView OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" ShowHeaderWhenEmpty="True" class="table container-fluid" ID="GridView1" runat="server" CellPadding="3" GridLines="Vertical" AutoGenerateColumns="False" ForeColor="Black" Font-Names="Arial" Font-Size="8pt" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px">
                    ...
                    <EditItemTemplate>  
                        <asp:TextBox ID="TxtBox_Num_pub" runat="server" Text='<%#Eval("Num_pub") %>'></asp:TextBox>                     
                           ...
                           <asp:TemplateField HeaderText="Action">
                            ...
                            <ItemTemplate>                            
                                <asp:Button ID="Generate_doc" CssClass="btn-success border-0 my-1 py-1 px-1 rounded-2 btn-action" runat="server"  Text="Générer Doc" OnClick="Generate_doc_Click" />
                            ...
                            <EditItemTemplate>  
                                <asp:Button ID="btn_Update" runat="server" CssClass="btn-success border-0 my-1 py-1 px-1 rounded-2 btnnewstyle " Text="mettre a jour" CommandName="Update"/>  
                                <asp:Button ID="btn_Cancel" runat="server" CssClass="btn-danger border-0 my-1 py-1 px-1 rounded-2 btn-action btnnewstyle" Text="Annuler" CommandName="Cancel"/>  
                            </EditItemTemplate>  
                        </asp:TemplateField>
